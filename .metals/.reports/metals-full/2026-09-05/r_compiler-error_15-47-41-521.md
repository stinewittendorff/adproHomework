error id: DD38DE9CBA98AD074374005BB01EE9D1
...
object List: 
  ...
  def addPairwise (l: List[Int], r: List[Int]): List[Int] = 
    (list1, list2) match
      case (_, Nil) => Nil
      case (Nil, _) => Nil
      case (Cons(h1, t1), Cons(h2, t2)) => Cons(h@@2), addPairwise())
...
dotty.tools.dotc.parsing.Scanners$Region.commasExpectedInEnclosing(Scanners.scala:1666)
	...
	dotty.tools.pc.WithSymbolSearchCollector.<init>(PcCollector.scala:351)
	dotty.tools.pc.PcDocumentHighlightProvider.<init>(PcDocumentHighlightProvider.scala:17)
	dotty.tools.pc.ScalaPresentationCompiler.documentHighlight$$anonfun$1(ScalaPresentationCompiler.scala:245)

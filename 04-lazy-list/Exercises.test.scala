...
object LazyListSpec
  ...
  property("Ex01.03: The 'to' list is long (shall pass after Ex. 5 is solved)") =
    to(0).exists { _ == -999 }
  ...
  property("Ex05.04: non-empty filter result implies exists on finite lists (requires Ex08 done)") =
